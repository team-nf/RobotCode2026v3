...
public class HopperConstants {
  ...
  public static final TalonFXConfiguration HOPPER_MOTOR_CONFIG =
  ...
  public static final TalonFXConfiguration HOPPER_SIDE_MOTOR_CONFIG =
      new TalonFXConfiguration()
          .withSlot0(
              new Slot0Configs()
                  .withKS(HOPPER_KS)
  ...
  public static final VelocityVoltage HOPPER_VELOCITY_CONTROL =
  ...
  public static final AngularVelocity HOPPER_FEEDING_VELOCITY =
      RotationsPerSecond.of(20); // in RPS 20
  ...
  public static final AngularVelocity HOPPER_REVERSE_VELOCITY =
      RotationsPerSecond.of(-10.0); // in RPS -10
  public static final double HOPPER_ALLOWABLE_ERROR_RPS =
      HOPPER_ALLOWABLE_ERROR.in(RotationsPerSecond);
  public static final double HOPPER_FEEDING_VELOCITY_RPS =
      HOPPER_FEEDING_VELOCITY.in(RotationsPerSecond);
  public static final double HOPPER_SIDE_PUSHING_VELOCITY_RPS =
      HOPPER_SIDE_PUSHING_VELOCITY.in(RotationsPerSecond);
  public static final double HOPPER_REVERSE_VELOCITY_RPS =
      HOPPER_REVERSE_VELOCITY.in(RotationsPerSecond);
  ...
  public static final MomentOfInertia HOPPER_MOMENT_OF_INERTIA =
