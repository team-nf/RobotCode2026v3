...
public class FeederConstants {
 ...
 // FEED motor PID/feedforward
  public static final double FEEDER_FEED_KS = 0.20536;
  public static final double FEEDER_FEED_KV = 0.11887;
  public static final double FEEDER_FEED_KA = 0.0052158;
  public static final double FEEDER_FEED_KP = 0.10035;
  public static final double FEEDER_FEED_KI = 0.0;
  public static final double FEEDER_FEED_KD = 0.0;

  public static final TalonFXConfiguration FEEDER_BELT_MOTOR_CONFIG =
  ...
  public static final AngularVelocity FEEDER_REVERSE_VELOCITY =
      RotationsPerSecond.of(-2.0); // in RPS
  public static final double FEEDER_ALLOWABLE_ERROR_RPS =
      FEEDER_ALLOWABLE_ERROR.in(RotationsPerSecond);
  public static final double FEEDER_FEEDING_VELOCITY_RPS =
      FEEDER_FEEDING_VELOCITY.in(RotationsPerSecond);
  public static final double FEEDER_FEEDING_BELT_VELOCITY_RPS =
      FEEDER_FEEDING_BELT_VELOCITY.in(RotationsPerSecond);
  public static final double FEEDER_REVERSE_VELOCITY_RPS =
      FEEDER_REVERSE_VELOCITY.in(RotationsPerSecond);
