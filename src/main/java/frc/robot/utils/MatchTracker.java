...
public class MatchTracker {
    ...
    private BooleanPublisher isBlueHubActivePublisher = table.getBooleanTopic("IsBlueHubActive").publish();
    private BooleanPublisher isRedHubActivePublisher = table.getBooleanTopic("IsRedHubActive").publish();
    private DoublePublisher activePhaseDurationPublisher = table.getDoubleTopic("ActivePhaseDuration").publish();
