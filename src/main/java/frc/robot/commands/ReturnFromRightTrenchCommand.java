...
/** Returns from right trench toward shooting area while shifting machine to neutral idle. */
/* You should consider using the more terse Command factories API instead https://docs.wpilib.org/en/stable/docs/software/commandbased/organizing-command-based.html#defining-commands */
public class ReturnFromRightTrenchCommand extends ParallelCommandGroup {

  /** Creates a new ReturnFromRightTrenchCommand. */
  public ReturnFromRightTrenchCommand(CommandSwerveDrivetrain drivetrain, TheMachine theMachine) {
    Command builtCommand;
    try {
      PathPlannerPath path = PathPlannerPath.fromPathFile("ReturnFromRightTrench");
      ...
      DriverStation.reportError("Failed to load path 'ReturnFromRightTrench'", ex.getStackTrace());
      builtCommand =
